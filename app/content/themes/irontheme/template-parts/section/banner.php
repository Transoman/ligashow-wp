<div class="banner<?php echo get_sub_field('filter_off') ? '' : ' banner--filter'; ?>">
	<div class="container">
		<div class="banner__content">
			<h2 class="banner__title"><?php the_sub_field('title'); ?></h2>
		...
		<?php echo wp_get_attachment_image(get_sub_field('img'), 'full', '', array('class' => 'banner__img')); ?>
